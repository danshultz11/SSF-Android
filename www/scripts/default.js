...
function populateIFrame(qs) {
    ...
    //Testing remove:
    //page = "resultsWithoutJquery.html";
    var fullUrl = "http://spacestationfinder.com/" + page + qs;
    //window.open(fullUrl, "_blank", "location=no");
    window.open(fullUrl);
}
...
function onGeolocationError(error) {
    ...
    if (message != "") {
        alert('Can\'t retrieve latitude and longitude information from this device - but you can still enter a city or ZIP code. \n\n' + message);
...
function friendlyUhaapiErrorMessage(errorCode) {
    ...
    switch (errorCode) {
        ...
        case "NO_SATELLITE":
            ...
            break;
        default:
            document.location.href = "http://spacestationfinder.com/ssf2/index.html?loc=" + $("#txtAddress").val();
    }
}
